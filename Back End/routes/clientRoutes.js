...
router.post('/send-email-verification-otp', authController.protect, clientController.sendEmailVerificationOTP);
router.post('/verify-email', authController.protect, clientController.verifyEmail);

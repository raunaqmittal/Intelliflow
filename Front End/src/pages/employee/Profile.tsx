          ...
          <Card className="bg-gradient-card shadow-card">
            ...
            <CardContent className="space-y-6">
                  ...
                  {isEditing ? (
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Input id="email" type="email" value={editForm.email} disabled readOnly className="mt-1 bg-gray-100 dark:bg-gray-800 cursor-not-allowed" />
                        <p className="text-xs text-muted-foreground mt-1">Email address cannot be changed. Contact support if needed.</p>
                      </div>
                      <div>
                        ...
                        />
                        <p className="text-xs text-muted-foreground mt-1">Phone number cannot be changed. Contact support if needed.</p>
                      </div>
                      <div>
              ...
              <div className="space-y-4">
                ...
                {((employee as any).phoneVerified || (employee as any).emailVerified) && (
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/30">
                  <div className="flex items-start space-x-3 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        {twoFactorEnabled 
                          ? `Enabled via ${twoFactorMethod === 'sms' ? `SMS to ${(employee as any).phone || 'your phone'}` : `Email to ${employee.email}`}`
                      ...
                      {twoFactorMethod === 'sms' && (employee as any).phoneVerified && (
                  ...
                  <Button
                    ...
                    disabled={isTogglingTwoFactor || (!(employee as any).phoneVerified && !(employee as any).emailVerified)}
                    className="ml-4"
                  >
